import {ethereum, handleError, notifyError, chainConfig} from "..";
...
class WStakeContract {
    ...
    constructor() {
        ...
        this.wStakeAddress = config.wstakeContract;
        this.bondAddress = config.bondTokenContract;
        this.lpTokenAddress = config.lpContract;
    }
