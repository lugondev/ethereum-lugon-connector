import {valueToHex, ChainId} from "..";
...
class Ethereum {
    ...
    setAccount(account: string | null | undefined): Ethereum {
        console.log("-----> logged: " + account);
        this.account = account;
        return this;
    }

    setChainId(chainId: number | undefined): Ethereum {
...
export let ethereum = new Ethereum();
